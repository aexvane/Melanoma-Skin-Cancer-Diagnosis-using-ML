...
name = "efficientnetb3_yahya{}".format(int(time.time()))
...
def plot_hist(hist):
    ...
    plt.savefig(f'./effnetb3.png')
    plt.show()

src_path_train = "../../jpeg/train/"
...
checkpoint = ModelCheckpoint(f'./effnetb3.h5',verbose=1, save_best_only=False,
